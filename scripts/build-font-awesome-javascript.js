...
var generateFile = function (err, data) {
  ...
  fs.writeFile(__dirname+'/../public/the-graph/font-awesome-unicode-map.js', output, function (err) {
    if (err) {
      throw err;
    }
...
fs.readFile( __dirname+'/../public/bower_components/font-awesome/less/variables.less', 'utf8', generateFile );
